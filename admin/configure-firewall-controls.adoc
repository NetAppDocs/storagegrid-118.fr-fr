...
.Étapes
. Sélectionnez *gérer l'accès externe*.
L'onglet affiche un tableau contenant tous les ports externes (ports accessibles par défaut par les nœuds non GRID) pour les nœuds de votre grille.
