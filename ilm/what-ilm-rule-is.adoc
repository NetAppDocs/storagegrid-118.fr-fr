...
* Vous spécifiez ensuite le moment où le placement s'appliquera, par rapport à l'heure de référence. Par exemple, un placement peut commencer le jour 0 et se poursuivre pendant 365 jours, par rapport au moment où l'objet a été ingéré.
...
La deuxième instruction de positionnement image:../media/icon_number_2.png["Icône numéro 1"] crée deux copies au bout d'un an et conserve ces copies pour toujours.
