...
* Pour ajouter une ou deux tiroirs d'extension à une appliance de stockage SG6060, accédez à https://docs.netapp.com/us-en/storagegrid-appliances/sg6000/adding-expansion-shelf-to-deployed-sg6060.html["Ajoutez un tiroir d'extension à SG6060 déployé"^].
* Pour un nœud logiciel, suivez les instructions de la section
