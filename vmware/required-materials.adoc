...
--
Migration des nœuds (si nécessaire):: Comprenez bien ceci link:../swnodes/node-container-migration-requirements.html["conditions requises pour la migration des nœuds"], si vous souhaitez effectuer une maintenance planifiée sur des hôtes physiques sans aucune interruption de service.
