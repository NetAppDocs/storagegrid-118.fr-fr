...
.Étapes
. Suivez les instructions d'installation d'un nouvel appareil de services SG100 ou SG1000. Voir https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/index.html["Démarrage rapide pour l'installation du matériel"^].
