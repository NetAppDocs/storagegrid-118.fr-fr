...
* *Pour les objets dans des compartiments S3 non conformes ou des conteneurs Swift*. Ce message est généré lorsque ILM démarre le processus de suppression d'un objet, car aucune instruction de placement dans les règles ILM actives ne s'applique actuellement à cet objet.
