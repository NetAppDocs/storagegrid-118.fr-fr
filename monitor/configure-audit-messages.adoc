...
NOTE: Si vous ne souhaitez pas utiliser de serveur syslog externe, ignorez cette étape et passez à l' <<Select-audit-information-destinations,Sélectionnez les destinations des informations d'audit>>.
...
NOTE: Certaines destinations ne sont disponibles que si vous avez configuré un serveur syslog externe.
