...
* Vous pouvez également regarder la vidéo : https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=e3a75bc1-47a2-44b9-a84d-b0b9011dc2d1["Vidéo : utilisation de metrics pour créer des alertes personnalisées dans StorageGRID 11.8"^].
+
