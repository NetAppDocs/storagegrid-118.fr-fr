...
NOTE: En règle générale, incluez toujours ces en-têtes dans `CanonicalHeaders` Pour s'assurer qu'ils sont vérifiés, cependant, si vous excluez ces en-têtes, StorageGRID ne renvoie pas d'erreur.
